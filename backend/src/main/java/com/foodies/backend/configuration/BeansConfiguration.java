...
public class BeansConfiguration {
    ...
    FoodListStorage FoodListLoader() {
        ...
        Menu severy = new Menu(new ArrayList<>(
                List.of(new Dish("Pizza", "https://images.unsplash.com/photo-1504308805006-0f7a5f1f0f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3174&q=80"),
                        ...
                        new Dish("Sushi", "https://images.unsplash.com/photo-1504308805006-0f7a5f1f0f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=3174&q=80"))), MenuType.SEVERY);
        return new FoodListStorage(new ArrayList<>(List.of(sweet, severy)));
    }
